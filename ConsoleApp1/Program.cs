...
class Program
{
    static async Task Main()
    {
        ...
        //using var llama = new LlamaWrapper();

        //var modelPath = @"e:\gguf\mistral-7b-instruct-v0.2.Q8_0.gguf";
        //// Auto-detect best GPU backend
        ////llama.LoadModel(modelPath);

        //// Or specify explicitly
        //llama.LoadModel(modelPath, gpuLayers: 35);

        //var response = llama.GenerateText("The future of AI is");
    ...
    public static async Task Run()
{
    ...
    {
        GpuLayerCount = -1 // use all available GPU layers
        };
